		...
		$.getJSON(`/students/${userid}`, d => {
			...
			$(`#about`).html(`<h5 class="h6 card-title">About</h5>
									<ul class="list-unstyled mb-0">
										...
										<li id = "updateEmail" class="mb-1"><span data-feather="briefcase" class="feather-sm mr-1"></span> 생년월일 : <a href="#">${d.ssn}</a></li>
			...
			$(`#info-update`).click(e=>{
				...
				$(`#updateEmail`).html(`<span data-feather="briefcase" class="feather-sm mr-1"></span> 이메일 : <input type ="text" placeholder="${d.email}">`)
				$(`#updateAddr`).html(`<span data-feather="map-pin" class="feather-sm mr-1"></span> 주소 :<input type ="text" placeholder="서울"><br/>
				<button>수정확인</button><button>수정취소</button>`)
			})
