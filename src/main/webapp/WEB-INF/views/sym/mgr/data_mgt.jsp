    ...
    <table class="my-tab" id="mgr-tab">
    	...
    	<tr>
    		<td>학 생 (총 <span id="stu-count"></span> 명) <button id="mgr-truncate-stu">전체삭제</button><br/><br/>
    			...
    			<input type="text" id = "stu-data-birthday" placeholder="년도입력" /><button>년도 이후 입학</button>
    		</td>
    		<td>
    	...
    	<tr>
    		<td>교강사<br/><br/>
    		<input type="text" id="tea-data-count"/><button id="mgr-insert-many-tea">생성</button><br/><br/>
	    		<input type="radio" name="tea-data-gender" value= "M" checked="checked"/>남성
	    		<input type="radio" name="tea-data-gender"value= "F"/>여성<button style="margin-left:38px">성별조회</button><br/><br/>
    	...
    	<tr>
    		<td>사 원<br/><br/>
    		<input type="text" id="emp-data-count"/><button id="mgr-insert-many-tea">생성</button><br/><br/>
	    		<input type="radio" name="emp-data-gender" value= "M" checked="checked"/>남성
	    		<input type="radio" name="emp-data-gender"value= "F"/>여성<button style="margin-left:38px">성별조회</button><br/><br/>
	    		<input type="text" id="emp-data-count"/><button>수정</button><br/><br/>
	    		<input type="text" id="emp-data-count"/><button>삭제</button><br/><br/>
	    		<button>전체삭제</button>
